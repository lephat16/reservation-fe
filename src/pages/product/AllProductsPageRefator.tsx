import { alpha, Box, Checkbox, CircularProgress, Collapse, FormControl, IconButton, InputBase, InputLabel, ListItemText, MenuItem, OutlinedInput, Paper, Select, Skeleton, Stack, styled, Table, TableBody, TableCell, TableContainer, TableFooter, TableHead, TablePagination, TableRow, TableSortLabel, Toolbar, Tooltip, Typography, useTheme, type SelectChangeEvent } from "@mui/material"
...
import type { ProductStockData, SupplierProductStockData } from "../../types/stock";
import SearchIcon from '@mui/icons-material/Search';
import DeleteIcon from '@mui/icons-material/Delete';
import VisibilityIcon from '@mui/icons-material/Visibility';
import { DeleteConfirmDialog } from "./ProductPage";
                            ...
                            <Table size="small" aria-label="purchases">
                                <TableHead>
                                    <TableRow>
                                        ...
                                        <TableCell align="right">仕入れ価格</TableCell>
                                    </TableRow>
                                </TableHead>
                                <TableBody>
...
const AllProductsPageRefator = () => {
    ...
    const { isLoading, error, data } = useQuery({
        ...
        queryFn: async () => {
            const resStockProduct = await ApiService.getAllStockWithSupplierAndProduct();
    ...
    const filteredInventoryByCategories = filterdInventoryBySearch.filter(item =>
        // categoryNames.includes(item.product.categoryName)
    ...
    const filteredInventoryByQtyAndStatus =
        filteredInventoryByCategories
            .filter(item => {
                ...
                if (selectedStatus !== "") {
                    // if (item.supplierProduct.status !== selectedStatus) return false;
