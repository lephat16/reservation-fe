...
const PurchaseOrderPage = () => {
    ...
    const columns = [
        ...
        { key: "status", label: "ステータス", width: isMobile ? "30%" : "15%", truncate: true },
        { key: "userName", label: "ユーザー", width: "15%", truncate: true, hideOnMobile: true },
        { key: "total", label: isMobile ? "合計" : "合計金額", width: isMobile ? "30%" : "15%", align: "right", truncate: true },
