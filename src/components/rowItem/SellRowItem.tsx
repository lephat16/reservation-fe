...
import type { SellRow } from "../../pages/sell/CreateSellPage";
    ...
    return (
        ...
        >
                ...
                >
                    ...
                    <List>
                        <ListItem>
                            ...
                            <ListItemText primary={`仕入価格: ${selectedProduct?.price?.toLocaleString() ?? 0} ¥`} />
                        </ListItem>
                        <ListItem>
                            <ListItemAvatar>
                                <Avatar>
            ...
            >
                <Tooltip title="削除">
                    <span>
                        <IconButton size="small" onClick={() => onDelete(index)} disabled={totalRows === 1}>
                            <DeleteOutlineIcon />
                        </IconButton>
                    </span>
                </Tooltip>
